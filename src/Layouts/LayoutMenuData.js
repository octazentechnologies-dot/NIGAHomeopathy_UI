...
const Navdata = () => {
    ...
    const [isClinicalPatterns, setIsClinicalPatterns] = useState(false);
    const [isRepertory, setIsRepertory] = useState(false);
    const [isMateriaMedica, setIsMateriaMedica] = useState(false);
    const [isAdverseEffect, setIsAdverseEffect] = useState(false);
    const [isDeepAnalytics, setIsDeepAnalytics] = useState(false);
    const [isBusinessManagement, setIsBusinessManagement] = useState(false);
    const [is3DBodyPart, setIs3DBodyPart] = useState(false);
    const [isRubricIntelligence, setIsRubricIntelligence] = useState(false);
    ...
    useEffect(() => {
        ...
        if (iscurrentState !== 'ExistanceQuestions') {
            setIsExistanceQuestions(false);
        }
        if (iscurrentState !== 'ClinicalPatterns') {
            setIsClinicalPatterns(false);
        }
        if (iscurrentState !== 'Repertory') {
            setIsRepertory(false);
        }
        if (iscurrentState !== 'MateriaMedica') {
            setIsMateriaMedica(false);
        }
        if (iscurrentState !== 'AdverseEffect') {
            setIsAdverseEffect(false);
        }
        if (iscurrentState !== 'DeepAnalytics') {
            setIsDeepAnalytics(false);
        }
        if (iscurrentState !== 'BusinessManagement') {
            setIsBusinessManagement(false);
        }
        if (iscurrentState !== '3DBodyPart') {
            setIs3DBodyPart(false);
        }
        if (iscurrentState !== 'RubricIntelligence') {
            setIsRubricIntelligence(false);
        }
    ...
    const menuItems = [
...

        {
            ...
            link: "/#",
            stateVariables: isExistanceQuestions,
            click: function (e) {
                e.preventDefault();
                setIsExistanceQuestions(!isExistanceQuestions);
                setIscurrentState('ExistanceQuestions');
                updateIconSidebar(e);
            },
            subItems: [
                {
                    id: "analytics",
                    label: "Existance",
                    link: "/admin/listexistance",
                    parentId: "existancequestions",
                },
                {
                    id: "crm",
                    label: "Question Group",
                    link: "/admin/listquestiongroup",
                    parentId: "existancequestions",
                },
                {
                    id: "ecommerce",
                    label: "Sub Question Group",
                    link: "/admin/listsubquestiongroup",
                    parentId: "existancequestions",
                },
                {
                    id: "crypto",
                    label: "Clinical Questions",
                    link: "/admin/listclinicalquestion",
                    parentId: "existancequestions",
                },
            ],
        },

        {
            ...
            link: "/#",
            stateVariables: isClinicalPatterns,
            click: function (e) {
                e.preventDefault();
                setIsClinicalPatterns(!isClinicalPatterns);
                setIscurrentState('ClinicalPatterns');
                updateIconSidebar(e);
            },
            subItems: [
                {
                    ...
                    link: "/admin/listdiagnosissystem",
                    parentId: "clinicalpatterns",
                },
                {
                    id: "ecommerce",
                    label: "Diagnosis Therapeutics",
                    link: "/admin/listdiagnosistherapeuticsdetails" ,
                    parentId: "clinicalpatterns",
                },
                {
                    id: "crypto",
                    label: "Diagnosis & Conditions",
                    link: "/admin/listdiagnosisconditions",
                    parentId: "clinicalpatterns",
                },    
            ],
        },

        {
            ...
            icon: " ri-book-3-line",
            link: "/#",
            stateVariables: isRepertory,
            click: function (e) {
                e.preventDefault();
                setIsRepertory(!isRepertory);
                setIscurrentState('Repertory');
                updateIconSidebar(e);
            },
            subItems: [
                {
                    id: "crm",
                    label: "Section",
                    link: "/admin/listsection",
                    parentId: "repertory",
                },
                {
                    id: "crypto",
                    label: "Sub Section",
                    link: "/admin/listsubsection",
                    parentId: "repertory",
                },
                {
                    id: "crypto",
                    label: "Add Remedies",
                    link: "/admin/listrubrics",
                    parentId: "repertory",
                },
                {
                    id: "crypto",
                    label: "Remedial Rubrics",
                    link: "/admin/listremedialrubrics",
                    parentId: "repertory",
                },
                {
                    id: "crypto",
                    label: "Language",
                    link: "/admin/listlanguage",
                    parentId: "repertory",
                },
                {
                    id: "crypto",
                    label: "Body Parts",
                    link: "/admin/listbodyparts",
                    parentId: "repertory",
                },
                {
                    id: "crypto",
                    label: "Intensity",
                    link: "/admin/listintensity",
                    parentId: "repertory",
                },
                {
                    id: "crypto",
                    label: "Remedy",
                    link: "/admin/listremedy",
                    parentId: "repertory",
                },
                {
                    id: "crypto",
                    label: "Remedy Grade",
                    link: "/admin/listremedygrade",
                    parentId: "repertory",
                },
            ],
        },

        {
            ...
            icon: "ri-hail-line",
            link: "/#",
            stateVariables: isMateriaMedica,
            click: function (e) {
                e.preventDefault();
                setIsMateriaMedica(!isMateriaMedica);
                setIscurrentState('MateriaMedica');
                updateIconSidebar(e);
            },
            subItems: [
                {
                    id: "analytics",
                    label: "Author",
                    link: "/admin/listauthor",
                    parentId: "materiamedica",
                },
                {
                    id: "crm",
                    label: "Materia Medica Remedies",
                    link: "/admin/listmateriamedicaremedies",
                    parentId: "materiamedica",
                },
                {
                    id: "ecommerce",
                    label: "Materia Medica",
                    link: "/admin/listmateriamedica",
                    parentId: "materiamedica",
                },
                {
                    id: "crypto",
...

        {
            ...
            link: "/#",
            stateVariables: isAdverseEffect,
            click: function (e) {
                e.preventDefault();
                setIsAdverseEffect(!isAdverseEffect);
                setIscurrentState('AdverseEffect');
                updateIconSidebar(e);
            },
            subItems: [
                {
                    id: "analytics",
                    label: "Drug System",
                    link: "/admin/listdrugsystem",
                    parentId: "adverseeffect",
                },
                {
                    id: "crm",
                    label: "Drug Group",
                    link: "/admin/listdruggroup",
                    parentId: "adverseeffect",
                },
                {
                    id: "ecommerce",
                    label: "Allopathic Drug",
                    link: "/admin/listallopathicdrug",
                    parentId: "adverseeffect",
                },
            ],
        },

        {
            ...
            link: "/#",
            stateVariables: isDeepAnalytics,
            click: function (e) {
                e.preventDefault();
                setIsDeepAnalytics(!isDeepAnalytics);
                setIscurrentState('DeepAnalytics');
                updateIconSidebar(e);
            },
            subItems: [
                {
                    id: "analytics",
                    label: "Deep Analytics",
                    link: "/admin/commingsoon",
                    parentId: "deepanalytics",
                },
                {
                    id: "crm",
                    label: "Deep Analytics Demo",
                    link: "/admin/commingsoon",
                    parentId: "deepanalytics",
                },
            ],
...

        {
            ...
            click: function (e) {
                e.preventDefault();
                setIsBusinessManagement(!isBusinessManagement);
                setIscurrentState('BusinessManagement');
                updateIconSidebar(e);
            },
            subItems: [
                {
                    id: "analytics",
                    label: "Packages",
                    link: "/admin/listpackage",
                    parentId: "businessmanagement",
                },
                {
                    id: "qualifications",
                    label: "Qualifications",
                    link: "/admin/listqualification",
                    parentId: "businessmanagement",
                },
                {
                    id: "crm",
...

        {
            ...
            click: function (e) {
                e.preventDefault();
                setIs3DBodyPart(!is3DBodyPart);
                setIscurrentState("3DBodyPart");
                updateIconSidebar(e);
            },
            subItems: [
                {
                    id: "meshkeymaster",
                    label: "Mesh Key Master",
                    link: "/admin/listmeshkeymaster",
                    parentId: "3dbodypart",
                },
                {
                    id: "sectionmaster",
                    label: "Section Master",
                    link: "/admin/list3dsectionmaster",
                    parentId: "3dbodypart",
                },
                {
                    id: "hotspots",
                    label: "Hotspots",
                    link: "/admin/list3dhotspots",
                    parentId: "3dbodypart",
                },
            ],
        },
        {
            id: "rubricintelligence",
            label: "Rubric Intelligence",
            icon: "ri-brain-line",
            link: "/#",
            click: function (e) {
                e.preventDefault();
                setIsRubricIntelligence(!isRubricIntelligence);
                setIscurrentState("RubricIntelligence");
                updateIconSidebar(e);
            },
            stateVariables: isRubricIntelligence,
            subItems: [
                {
                    id: "rubricmetaphors",
                    label: "Metaphors",
                    link: "/admin/listrubricmetaphors",
                    parentId: "rubricintelligence",
                },
                {
                    id: "rubricaliases",
                    label: "Aliases",
                    link: "/admin/listrubricaliases",
                    parentId: "rubricintelligence",
                },
                {
                    id: "rubricbenchmark",
                    label: "Benchmark",
                    link: "/admin/rubric-intelligence-benchmark",
                    parentId: "rubricintelligence",
                },
            ],
        },
