...
const RightSidebar = (props) => {
    ...
    const { open, toggle: toggleLeftCanvas } = useThemeCustomizer();
        ...
        <React.Fragment>
            <div className="velzon-floating-actions">
                <button
                    type="button"
                    onClick={() => toTop()}
                    className="btn btn-dark btn-sm btn-icon rounded-pill shadow-lg p-1 waves-effect waves-light"
                    id="back-to-top"
                    aria-label="Back to top"
                >
                    <i className="ri-arrow-up-line fs-16"></i>
                </button>
            </div>
            ...
            <div>
                <Offcanvas isOpen={open} toggle={toggleLeftCanvas} direction="end" className="offcanvas-end border-0">
                    <OffcanvasHeader className="d-flex align-items-center bg-white border-bottom p-3 theme-customizer-header" toggle={toggleLeftCanvas}>
                        <span className="m-0 me-2 text-body fw-semibold">Theme Customizer</span>
                    </OffcanvasHeader>
