...
const MateriaMedicaRemediesList = () => {
  ...
  const showSpinner = materiaMedicaLoading && firstLoad;
                ...
                <CardBody>
                                ...
                                <td className="text-center">
                                  <div className="d-inline-flex gap-2">
                                    <div className="remove">
                                      <Link to="/admin/viewmateriamedicaremedies" state={{ selectedRemedy: remedy }}>
                  ...
                  <div className="d-flex align-items-center justify-content-between patient-list-modal__footer">
                    <div className="text-muted patient-list-modal__footer-text">
                      {showSpinner
                        ? 'Loading...'
                        : `Showing ${remedys.length} of ${totalRecords} Results · Page ${currentPage} of ${totalPages}`}
                    </div>
