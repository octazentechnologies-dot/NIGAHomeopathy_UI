...
import { Card, CardHeader, CardBody, CardFooter, Col, Container, Label, Row, Button, FormFeedback, UncontrolledAlert } from 'reactstrap';
            ...
            <Col lg={12}>
              <Card>
                ...
                <CardHeader className="align-items-center d-flex">
                  <h4 className="card-title mb-0 flex-grow-1">Edit Diagnosis Therapeutics Details</h4>
                </CardHeader>
                    ...
                    <Row className="g-4">
                      ...
                      <Col className="col-sm-auto">
                        <div className="d-inline-flex gap-2">
                          ...
                          <Button color="success" className="btn-label" type="submit" disabled={formik.isSubmitting || loading}> <i className="ri-save-2-line label-icon align-middle fs-16 me-2"></i> {loading ? <Spinner size="sm" /> : 'Update'} </Button>
                        </div>
                      </Col>
                    </Row>
                  </CardFooter>
