...
const ListHotspots = () => {
  ...
  const totalRecords =
    useSelector((state) => state?.AnatomyHotspot?.anatomyHotspotList?.totalRecordCount) ||
    items.length ||
    0;

  useEffect(() => {
    dispatch(getAnatomyHotspotsList({
                ...
                <CardHeader className="border-0">
                  <div className="admin-list-toolbar d-flex align-items-center justify-content-between gap-2 flex-wrap w-100">
                    ...
                    <div className="admin-list-toolbar__actions d-flex align-items-center gap-2 flex-shrink-0 ms-auto">
                      ...
                      <Link to="/admin/add3dhotspots" className="d-inline-flex">
                          ...
                          {items.length > 0 ? (
                              ...
                              <tr key={row.hotspotId ?? row.anatomyHotspotId ?? index}>
                                ...
                                <td className="text-center">
                                  <div className="d-inline-flex gap-2">
                                    <Link to="/admin/edit3dhotspots" state={{ selectedHotspot: row }}>
                            ...
                            <tr>
                              <td colSpan={4} className="text-center text-muted py-4">
                                {searchQuery ? 'No hotspots match your search' : 'No Hotspots Available'}
                              </td>
                            </tr>
                          )}
                        </tbody>
