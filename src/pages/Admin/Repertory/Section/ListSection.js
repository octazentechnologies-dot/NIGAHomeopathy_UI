...
const SectionList = () => {
  ...
  useEffect(() => {
    dispatch(getSectionList({ PageNumber: currentPage, PageSize: pageSize }));
  }, [currentPage]);

  // Pagination Handlers
  const handlePrevPage = () => {
    if (currentPage > 1) {
      dispatch(getSectionList({ PageNumber: currentPage - 1, PageSize: pageSize }));
                        ...
                        {sectionLoading ? (
                          ...
                          <tbody>
                            {sections?.length > 0 ? (
                                  ...
                                  <td className="text-center">
                                    <div className="d-inline-flex gap-2">
                                      ...
                                      <div className="remove">
                                        <button className="btn btn-sm btn-soft-danger remove-item-btn" onClick={() => onClickDelete(section)}>
                              ...
                              <tr>
                                <td colSpan="5" className="text-center">No Sections Available</td>
                              </tr>
                            )}
                          </tbody>
                        )}
