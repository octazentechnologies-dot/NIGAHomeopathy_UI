...
import { getNewsById } from "../../Minimaltheme/helpers/marketingApi";
...
const NewsDetailPage = () => {
    ...
    const images = news
        ? [news.newsImage1, news.newsImage2, news.newsImage3, news.newsImage4].filter(Boolean)
        : [];
                ...
                <Container>
                    {loading ? (
                        ...
                        <div className="text-center text-danger py-5">
                            {error}{" "}
                            <Link to={landingPath("news")} className="ms-2">
                                Back to News
                            </Link>
                        </div>
                    ) : (
                        <Row className="justify-content-center">
                            <Col lg={10}>
                                ...
                                {news.newsSubHeading && (
                                    <p className="lead text-muted ff-secondary">{news.newsSubHeading}</p>
                                )}
                                {images.length > 0 && (
                                ...
                                <div className="mt-4">
                                    <Link to={landingPath("news")} className="btn btn-soft-primary">
