...
const RAW_SECTIONS = [
    ...
    { title: "10. Ownership and Restrictions on Use", html: `<p>The Site is owned and operated by Homeocentrum and the information provided by the Site are and will remain the property of Homeocentrum and are protected by copyright, trademark and other laws. You may not copy, reproduce, republish, upload, post, transmit or distribute any content or information available on or through the Site without our prior written permission.</p>` },
    { title: "11. Termination", html: `<p>This Agreement shall remain effective unless terminated due to: failure to pay subscription fee; breach of any term; illegal, fraudulent or abusive behavior; or acts prejudicial to the interests of Homeocentrum. Upon termination of this Agreement, Your right to use the Site shall immediately cease.</p>` },
    { title: "12. Uptime Guarantee", html: `<p>Homeocentrum will use commercially reasonable efforts to ensure that the site will be available for use at least 95% of the time over each calendar month, available between the hours of 8.00AM and 6.00PM, Indian Standard Time, Monday through Saturday.</p>` },
    { title: "13. Disclaimers", html: `<p>THE SITE, THE MATERIALS ON THE SITE, ANY PRODUCT OR SERVICE OBTAINED THROUGH THE SITE AND THE SOFTWARE ARE PROVIDED "AS IS" AND WITHOUT WARRANTIES OF ANY KIND, EITHER EXPRESS OR IMPLIED. TO THE FULLEST EXTENT PERMISSIBLE PURSUANT TO APPLICABLE LAW, HOMEOCENTRUM DISCLAIMS ALL WARRANTIES, EXPRESS OR IMPLIED.</p>` },
    { title: "14. Limitation of Liability", html: `<p>NEITHER HOMEOCENTRUM NOR ANY OF OUR AFFILIATES, LICENSORS, SUPPLIERS, ADVERTISERS OR SPONSORS ARE RESPONSIBLE OR LIABLE FOR ANY INDIRECT, INCIDENTAL, CONSEQUENTIAL, SPECIAL, EXEMPLARY, PUNITIVE OR OTHER DAMAGES ARISING OUT OF OR RELATING IN ANY WAY TO THE SITE.</p>` },
    { title: "15. Indemnification", html: `<p>You agree to indemnify, defend and hold Homeocentrum harmless from and against any and all claims, damages, losses, costs and other expenses that arise directly or indirectly out of or from your breach of this Agreement and/or your activities in connection with the Site.</p>` },
    { title: "16. Cancellation and Refund of Respective Subscription Fee", html: `<p>Homeocentrum does not offer subscription cancellation and no refunds will be made for early termination of the contract prior to the end of the active subscription period(s).</p>` },
    { title: "17. Renewal", html: `<p>You can renew your subscription no earlier than 3 months before it expires. At the end of each subscription period a grace period of 30 calendar days will be given to renew the respective subscription and continue using the Homeocentrum system.</p>` },
    { title: "18. Force Majeure", html: `<p>The duties and obligations of Homeocentrum under this Agreement shall be suspended during such time as the performance by Homeocentrum is prevented or impeded by major riots, civil commotion, rebellion, pestilence, pandemic, Governmental action, war, hostility, acts of God beyond the control of Homeocentrum.</p>` },
